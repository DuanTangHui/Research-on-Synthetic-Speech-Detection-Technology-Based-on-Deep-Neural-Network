...
if __name__ == '__main__':
    ...
    if data_type == 'time_frame':
        root_path = '../LAPA/'
        train_protocol_file_path = root_path + 'ASVspoof2019_LAPA_cm_protocols/ASVspoof2019.LAPA.cm.train.trn.txt'
        dev_protocol_file_path = root_path + 'ASVspoof2019_LAPA_cm_protocols/ASVspoof2019.LAPA.cm.dev.trl.txt'
        eval_protocol_file_path = root_path + 'ASVspoof2019_LAPA_cm_protocols/ASVspoof2019.LAPA.cm.eval.trl.txt'
        ...
        dev_protocol_file_path   = root_path + 'ASVspoof2019_LAPA_cm_protocols/ASVspoof2019.LAPA.cm.dev.trl.txt'
        eval_protocol_file_path  = root_path + 'ASVspoof2019_LAPA_cm_protocols/ASVspoof2019.LAPA.cm.eval.trl.txt'
        train_data_path = root_path + 'data/train_6.4_cqcc/'
        dev_data_path   = root_path + 'data/dev_6.4_cqcc/'
        eval_data_path  = root_path + 'data/eval_6.4_cqcc/'
        ...
        dev_protocol_file_path = root_path + 'ASVspoof2019_LAPA_cm_protocols/ASVspoof2019.LAPA.cm.dev.trl.txt'
        eval_protocol_file_path = root_path + 'ASVspoof2019_LAPA_cm_protocols/ASVspoof2019.LAPA.cm.eval.trl.txt'
        train_data_path = root_path + 'data/train_6.4_lfcc/'
        dev_data_path = root_path + 'data/dev_6.4_lfcc/'
        eval_data_path = root_path + 'data/eval_6.4_lfcc/'
    ...
    # '../PA/ASVspoof2019_PA_cm_protocols/ASVspoof2019.PA.cm.train.trn.txt
    # '../ PA /data/train_6/'
    ...
    for epoch in range(num_epoch):
        ...
        net_str = data_type + '_' + str(epoch) + '_' + 'ASVspoof20' + str(dataset) + '_LAPA_Loss_' + str(round(total_loss / counter, 4)) + '_dEER_' \
